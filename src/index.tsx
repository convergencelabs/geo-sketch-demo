...
import {pointerStore, modelStore, viewportStore} from "./stores/stores";
import {getDemoId} from "./utils/example-id.js";

// TODO move this into the app component using an effect.
const demoId = getDemoId();
const connectionManager = new ConnectionManager(demoId, viewportStore, pointerStore, modelStore);
